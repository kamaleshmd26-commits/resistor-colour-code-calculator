...
A simple browser-based tool to calculate resistor values from colour bands — supports 4-band, 5-band, and 6-band resistors with tolerance and temperature coefficient.
